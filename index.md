...
`API` `OK` のように**大文字が 2 文字以上続く部分は、そのままの表記で残ります**。
...
`api` のように**小文字の英単語はローマ字と区別できない**ため、かなに変換されます。大文字が 1 文字だけの場合も小文字になります。残したい場合は、間に半角スペースを入れてから変換してください。
...
<div class="faq">
  ...
  <details>
    ...
    <p>大文字が 2 文字以上続く部分は、そのままの表記で残ります。<code>api</code> のような小文字の英単語はローマ字と区別できないため、かなに変換されます。残したい場合は、間に半角スペースを入れてから変換してください。</p>
  </details>
  <details>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "大文字が 2 文字以上続く部分は、そのままの表記で残ります。api のような小文字の英単語はローマ字と区別できないため、かなに変換されます。残したい場合は、間に半角スペースを入れてから変換してください。"
      }
    },
    {
      "@type": "Question",
